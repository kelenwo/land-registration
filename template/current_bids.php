...
<script src="<?php echo base_url();?>template/assets/js/demo/datatables-demo.js"></script>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Sell Property</h1>
...
<!-- General Information end -->
 ...
 <button type="submit" class="btn pl-5 pr-5 btn-success" id="save<?php echo $req['id'];?>"><i class="far fa-edit"></i> Activate contract &nbsp;
             </form>

     <i id="loading-<?php echo $req['id'];?>" class="fas fa-cog fa-spin"></i></button>
     <?php endif;?>
     <?php if($req['contract_status']=='active' && $req['contract_status']!=='completed'): ?>
       <form id="update_contract_<?php echo $req['id'];?>">
         <input type="hidden" name="id" value="<?php echo $req['id'];?>">
         <input type="hidden" name="has_finished" value="yes">
       </form>
<button class="btn pl-5 pr-5 btn-success" id="save-<?php echo $req['id'];?>">
